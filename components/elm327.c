...
void elm327_print(elm327_data_t packet){
    ...
    ESP_LOGI("ELM327_DATAPRINT", "Oil Temp: %02x", packet.temp);
    ESP_LOGI("ELM327_DATAPRINT", "Fuel Level: %02x", packet.fuel);
    ESP_LOGI("ELM327_DATAPRINT", "Speed: %02x", packet.speed);
